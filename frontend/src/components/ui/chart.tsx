...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "border-neutral-200/50 bg-white grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-neutral-200 px-2.5 py-1.5 text-xs shadow-xl dark:border-neutral-800/50 dark:bg-neutral-950 dark:border-neutral-800 text-black",
        className
      )}
    >
